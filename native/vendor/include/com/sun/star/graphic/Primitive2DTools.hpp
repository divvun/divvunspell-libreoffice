...
#if defined LO_URE_CURRENT_ENV && defined LO_URE_CTOR_ENV_com_dot_sun_dot_star_dot_graphic_dot_Primitive2DTools && (LO_URE_CURRENT_ENV) == (LO_URE_CTOR_ENV_com_dot_sun_dot_star_dot_graphic_dot_Primitive2DTools) && defined LO_URE_CTOR_FUN_com_dot_sun_dot_star_dot_graphic_dot_Primitive2DTools
extern "C" ::css::uno::XInterface * SAL_CALL LO_URE_CTOR_FUN_com_dot_sun_dot_star_dot_graphic_dot_Primitive2DTools(::css::uno::XComponentContext *, ::css::uno::Sequence< ::css::uno::Any > const &);
#endif
...
public:
    static ::css::uno::Reference< ::css::graphic::XPrimitive2DRenderer > create(::css::uno::Reference< ::css::uno::XComponentContext > const & the_context) {
        ...
        try {
#if defined LO_URE_CURRENT_ENV && defined LO_URE_CTOR_ENV_com_dot_sun_dot_star_dot_graphic_dot_Primitive2DTools && (LO_URE_CURRENT_ENV) == (LO_URE_CTOR_ENV_com_dot_sun_dot_star_dot_graphic_dot_Primitive2DTools) && defined LO_URE_CTOR_FUN_com_dot_sun_dot_star_dot_graphic_dot_Primitive2DTools
            the_instance = ::css::uno::Reference< ::css::graphic::XPrimitive2DRenderer >(::css::uno::Reference< ::css::uno::XInterface >(static_cast< ::css::uno::XInterface * >((*LO_URE_CTOR_FUN_com_dot_sun_dot_star_dot_graphic_dot_Primitive2DTools)(the_context.get(), ::css::uno::Sequence< ::css::uno::Any >())), ::SAL_NO_ACQUIRE), ::css::uno::UNO_QUERY);
#else
            the_instance = ::css::uno::Reference< ::css::graphic::XPrimitive2DRenderer >(the_context->getServiceManager()->createInstanceWithContext( "com.sun.star.graphic.Primitive2DTools", the_context), ::css::uno::UNO_QUERY);
#endif
