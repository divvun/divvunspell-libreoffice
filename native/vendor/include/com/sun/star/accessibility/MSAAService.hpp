...
extern "C" ::css::uno::XInterface * SAL_CALL LO_URE_CTOR_FUN_com_dot_sun_dot_star_dot_accessibility_dot_MSAAService(::css::uno::XComponentContext *, ::css::uno::Sequence< ::css::uno::Any > const &);
#endif
...
public:
    static ::css::uno::Reference< ::css::accessibility::XMSAAService > create(::css::uno::Reference< ::css::uno::XComponentContext > const & the_context) {
        ...
        try {
#if defined LO_URE_CURRENT_ENV && defined LO_URE_CTOR_ENV_com_dot_sun_dot_star_dot_accessibility_dot_MSAAService && (LO_URE_CURRENT_ENV) == (LO_URE_CTOR_ENV_com_dot_sun_dot_star_dot_accessibility_dot_MSAAService) && defined LO_URE_CTOR_FUN_com_dot_sun_dot_star_dot_accessibility_dot_MSAAService
            the_instance = ::css::uno::Reference< ::css::accessibility::XMSAAService >(::css::uno::Reference< ::css::uno::XInterface >(static_cast< ::css::uno::XInterface * >((*LO_URE_CTOR_FUN_com_dot_sun_dot_star_dot_accessibility_dot_MSAAService)(the_context.get(), ::css::uno::Sequence< ::css::uno::Any >())), ::SAL_NO_ACQUIRE), ::css::uno::UNO_QUERY);
#else
            the_instance = ::css::uno::Reference< ::css::accessibility::XMSAAService >(the_context->getServiceManager()->createInstanceWithContext( "com.sun.star.accessibility.MSAAService", the_context), ::css::uno::UNO_QUERY);
#endif
