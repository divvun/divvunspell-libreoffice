...
#if defined LO_URE_CURRENT_ENV && defined LO_URE_CTOR_ENV_com_dot_sun_dot_star_dot_chart2_dot_LogarithmicRegressionCurve && (LO_URE_CURRENT_ENV) == (LO_URE_CTOR_ENV_com_dot_sun_dot_star_dot_chart2_dot_LogarithmicRegressionCurve) && defined LO_URE_CTOR_FUN_com_dot_sun_dot_star_dot_chart2_dot_LogarithmicRegressionCurve
extern "C" ::css::uno::XInterface * SAL_CALL LO_URE_CTOR_FUN_com_dot_sun_dot_star_dot_chart2_dot_LogarithmicRegressionCurve(::css::uno::XComponentContext *, ::css::uno::Sequence< ::css::uno::Any > const &);
#endif
...
public:
    static ::css::uno::Reference< ::css::chart2::XRegressionCurve > create(::css::uno::Reference< ::css::uno::XComponentContext > const & the_context) {
        ...
        try {
#if defined LO_URE_CURRENT_ENV && defined LO_URE_CTOR_ENV_com_dot_sun_dot_star_dot_chart2_dot_LogarithmicRegressionCurve && (LO_URE_CURRENT_ENV) == (LO_URE_CTOR_ENV_com_dot_sun_dot_star_dot_chart2_dot_LogarithmicRegressionCurve) && defined LO_URE_CTOR_FUN_com_dot_sun_dot_star_dot_chart2_dot_LogarithmicRegressionCurve
            the_instance = ::css::uno::Reference< ::css::chart2::XRegressionCurve >(::css::uno::Reference< ::css::uno::XInterface >(static_cast< ::css::uno::XInterface * >((*LO_URE_CTOR_FUN_com_dot_sun_dot_star_dot_chart2_dot_LogarithmicRegressionCurve)(the_context.get(), ::css::uno::Sequence< ::css::uno::Any >())), ::SAL_NO_ACQUIRE), ::css::uno::UNO_QUERY);
#else
            the_instance = ::css::uno::Reference< ::css::chart2::XRegressionCurve >(the_context->getServiceManager()->createInstanceWithContext( "com.sun.star.chart2.LogarithmicRegressionCurve", the_context), ::css::uno::UNO_QUERY);
#endif
